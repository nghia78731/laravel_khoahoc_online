...
<div class="container">
    ...
    <div class="table-responsive">
        <form action="{{ route('online_payment.store') }}" id="create_form" method="post">
            @csrf
            <div class="form-group">
                <label for="language">Loại hàng hóa </label>
                <select name="order_type" id="order_type" class="form-control">
                    <option value="topup">Nạp tiền đăng ký lớp học</option>
                </select>
            </div>
            <input  class="form-control" id="order_id" name="order_id" type="hidden" value="{{ $orderClass->key }}"/>
            <div class="form-group">
