...
<script type="text/javascript">
    ...
    var channel = pusher.subscribe('NotifiCourse');
...
@csrf
                                ...
                                <div class="media-body">
                                  <input type="hidden" value="`+data.student_id+`" id="student_id" name="student_id">
                                  <input type="hidden" value="`+data.class_id+`" id="class_id" name="class_id">
