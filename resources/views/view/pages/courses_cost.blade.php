                        ...
                        @foreach ($infoCourses as $infoCourse)
                            @if(isset($infoCourse->classOfTeacher->price))
                                <div class="col-lg-4 course_box">
                                    <div class="card">
                                        <form action="{{ route('online_payment.index') }}" method="post">
                                            @csrf
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <div class="card-quantity"<span style="color: red;font-size: medium">Giá tiền: </span>{{ number_format($infoCourse->classOfTeacher->price) }} VNĐ</div>
                                                <input type="hidden" value="{{ $infoCourse->classOfTeacher->id }}" name="class_id">
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                @elseif($infoCourse->classOfTeacher->current_quantity  < $infoCourse->classOfTeacher->capacity)
                                                    <button type="submit" class="btn btn-light" class="btn btn-success" style="width: 100%">Đăng ký học</button>
                                                @else
